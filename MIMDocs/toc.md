# [Übersicht](microsoft-identity-manager-2016.md)
...
## [Empfohlene Methoden](mim-best-practices.md)
...
## [Lizenzierung und Download](microsoft-identity-manager-licensing.md)
## [Datenverarbeitung](mim-privacy-compliance.md)
## [Bereitstellen in den TLS 1.2- oder FPS-mode-Umgebungen](preparing-tls.md)
## [Erstmalige Bereitstellung](microsoft-identity-manager-deploy.md)
### [Einrichten der Domäne](preparing-domain.md)
### [Domäneneinrichtung für GMSA](preparing-domain-gmsa.md)
...
### [Installieren von MIM: SQL-Datenbanken](install-mim-sync-ad-service.md)
## [Upgrade aus Forefront Identity Manager 2010 R2](microsoft-identity-manager-2016-upgrade-from-fim-2010-R2.md)
## [Upgrade auf MIM 2016 SP2](microsoft-identity-manager-2016-service-pack-2-upgrade-path.md)
...
## [Konfigurieren des Graph-Connectors für B2B](microsoft-identity-manager-2016-graph-b2b-scenario.md)
## [Verwenden des Azure MFA Server in PAM oder SSPR](working-with-mfaserver-for-mim.md)
## [Verwenden eines benutzerdefinierten MFA-Anbieters in PAM oder SSPR](working-with-custommfaserver-for-mim.md)
...
## [Best Practice Analyzer](https://technet.microsoft.com/library/jj203402)
...
## [Microsoft Identity Software: Public Release Build Versions](https://blogs.technet.microsoft.com/iamsupport/idmbuildversions/) (Microsoft-Identitätssoftware: veröffentlichte Buildversionen)
...
### [Detailliert Anleitung für generische SQL](./reference/microsoft-identity-manager-2016-connector-genericsql-step-by-step.md)
