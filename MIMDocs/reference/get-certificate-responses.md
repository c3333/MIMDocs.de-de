---
Titel: Abrufen von Zertifikatantworten
MS.Custom:
  - MIM
...
---
# Abrufen von Zertifikatantworten
...
certificaterequests | Die Liste der vom Client generierten Zertifikatanforderungen. Diese Anforderungen müssen unter Verwendung der im "certificaterequestgenerationoptions"-Objekt angegebenen Parameter erstellt worden sein; Weitere Informationen finden Sie unter [Abrufen Generierungsoptionen für Zertifikatanforderungen](get-certificate-request-generation-options.md).
...
###Antworttext
Bei Erfolg wird eine Liste von JSON-serialisierten Objekten [Microsoft.Clm.Shared.Certificates.Certificate](https://msdn.microsoft.com/en-us/library/microsoft.clm.shared.certificates.certificate(v=vs.100%29.aspx) mit den folgenden Eigenschaften zurückgegeben:
...
- [Microsoft.Clm.Provision.ExecuteOperations.Enroll-Methode](https://msdn.microsoft.com/en-us/library/microsoft.clm.provision.executeoperations.enroll.aspx)
- [Microsoft.Clm.Shared.Certificates.Certificate-Klasse](https://msdn.microsoft.com/en-us/library/microsoft.clm.shared.certificates.certificate(v=vs.100%29.aspx)
<!--HONumber=Mar16_HO1-->
