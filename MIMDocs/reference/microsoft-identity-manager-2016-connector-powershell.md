...
![Funktionen](./media/microsoft-identity-manager-2016-connector-powershell/capabilities.png)
...
| [Daten Normalisierung][DataNorm] |Weist den Synchronisierungsdienst an, Ankerattribute vor der Bereitstellung für Skripts zu normalisieren. |
