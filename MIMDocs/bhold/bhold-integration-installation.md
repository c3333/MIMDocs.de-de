...
| **Kennwort**        | Gibt das Kennwort des FIM-Administratorbenutzerkontos an.                                                                                                                                                                                 | Geben Sie das Kennwort hier ein: **Wichtig:** Achten Sie darauf, dieses Kennwort an einem verborgenen, sicheren Ort aufzubewahren. |
...
| **Kennwort**           | Gibt das Kennwort des Benutzerkontos an, das in **Benutzer** angegeben ist.                                                                                                                                                                                                                                                                                                                             | Geben Sie das Kennwort hier ein: **Wichtig:** Achten Sie darauf, dieses Kennwort an einem verborgenen, sicheren Ort aufzubewahren. |
