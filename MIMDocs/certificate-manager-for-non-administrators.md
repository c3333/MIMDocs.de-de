...
4.  Duplizieren Sie die Profilvorlage, und fügen Sie den ursprünglichen Administratorschlüssel zum Konfigurieren des MIM-Servers hinzu:
    ...
    5.  Geben Sie unter **Admin key initial value (hex)** (Administratorschlüssel-Anfangswert (hexadezimal)) den Standardadministratorschlüssel ein: "010203040506070801020304050607080102030405060708".
