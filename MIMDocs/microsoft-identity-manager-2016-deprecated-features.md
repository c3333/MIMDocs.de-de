...
| **Kategorie**                | **Veraltetes Feature**              | **Ersatz und Kommentar**           |
|--------|-------|---|    
| Attributrangfolge | Multi-Master-/gleiche Rangfolge                       | Die gleiche Rangfolge wird entfernt. Dieses Feature wird nicht ersetzt. Es wird empfohlen, die Rangfolge manuell festzulegen. Sie können dieses Feature weiterhin verwenden, wenn in Ihrer Umgebung ein FIM-Dienstverwaltungs-Agent bereitgestellt wurde. Dieser Verwaltungs-Agent bietet keine manuelle Rangfolge, um „export-not-precedent“ für das deklarative Bereitstellen zu vermeiden. |
